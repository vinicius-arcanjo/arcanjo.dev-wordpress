                                    ...
                                    <div class="qfb-tabs-panel">
                                        ...
                                        <div id="qfb-form-general-tabs">
                                            ...
                                            <ul class="qfb-tabs-nav qfb-sub-tabs-nav qfb-cf">
                                                <li><a><i class="mdi mdi-settings"></i><?php esc_html_e('Form', 'quform'); ?></a></li>
                                                <li><a><i class="mdi mdi-https"></i><?php esc_html_e('Limits', 'quform'); ?></a></li>
                                                <li><a><i class="mdi mdi-date_range"></i><?php esc_html_e('Scheduling', 'quform'); ?></a></li>
                                            </ul>
                                            ...
                                            <div class="qfb-tabs-panel">
                                                ...
                                                <div class="qfb-settings">
                                                    ...
                                                    <div class="qfb-settings-heading qfb-settings-heading-light-right"><?php esc_html_e('Form settings', 'quform'); ?><i class="mdi mdi-settings"></i></div>
                                            ...
                                            <div class="qfb-tabs-panel">
                                                ...
                                                <div class="qfb-settings">
                                                    ...
                                                    <div class="qfb-settings-heading qfb-settings-heading-light-right"><?php esc_html_e('Limits', 'quform'); ?><i class="mdi mdi-https"></i></div>
                                            ...
                                            <div class="qfb-tabs-panel">
                                                ...
                                                <div class="qfb-settings">
                                                    ...
                                                    <div class="qfb-settings-heading qfb-settings-heading-light-right"><?php esc_html_e('Scheduling', 'quform'); ?><i class="mdi mdi-date_range"></i></div>
                                                    ...
                                                    <div class="qfb-setting<?php echo $builder->getFormConfigValue($form, 'enableSchedule') ? '' : ' qfb-hidden'; ?>">
                                                        ...
                                                        <div class="qfb-setting-inner">
                                                            <div class="qfb-setting-input">
                                                                <input type="text" id="qfb_form_schedule_start" class="qfb-datetimepicker" value="<?php echo Quform::escape($builder->convertDateTimeToWpTimezone($builder->getFormConfigValue($form, 'scheduleStart'))); ?>">
                                                                <p class="qfb-description"><?php esc_html_e('The date and time when this form will open for for new submissions.', 'quform'); ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="qfb-setting<?php echo $builder->getFormConfigValue($form, 'enableSchedule') ? '' : ' qfb-hidden'; ?>">
                                                        ...
                                                        <div class="qfb-setting-inner">
                                                            <div class="qfb-setting-input">
                                                                <input type="text" id="qfb_form_schedule_end" class="qfb-datetimepicker" value="<?php echo Quform::escape($builder->convertDateTimeToWpTimezone($builder->getFormConfigValue($form, 'scheduleEnd'))); ?>">
